...
CREATE TABLE IF NOT EXISTS chat_messages (
    ...
    INDEX idx_chat_role (session_id, role),
...
CREATE TABLE IF NOT EXISTS chat_memory (
    ...
    memory_type VARCHAR(32) NOT NULL DEFAULT 'historical' COMMENT 'memory type: session/latest/historical',
    ...
    INDEX idx_created_at (created_at),
    INDEX idx_chat_keyword (session_id, keyword(64)),
    INDEX idx_time_range (start_time, end_time),
    INDEX idx_chat_type (session_id, memory_type)
) COMMENT='对话长期记忆摘要表';
