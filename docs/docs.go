...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/chat/messages/{session_id}/search": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
