...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_app_modules_sys_distributed_lock.acquireReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/sys_distributed_lock/check/{lock_key}": {
            "get": {
        ...
        "/sys_distributed_lock/query/{lock_key}": {
            "get": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_app_modules_sys_distributed_lock.releaseReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_app_modules_sys_distributed_lock.renewReq"
                        }
                    }
                ],
                "responses": {
                    ...
                    "403": {
                        "description": "无权限（holder不匹配或锁已过期）",
                        "schema": {
                            "$ref": "#/definitions/assistant_pkg_response.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/assistant_internal_app_repo.SearchSysServersByIDCParams"
                        }
                    }
                ],
                "responses": {
        ...
        "/sys_server/search_by_idc_and_svr_ip": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/assistant_internal_app_repo.SearchSysServersByIDCAndSvrIPParams"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/assistant_internal_app_repo.SearchSysServersBySvrIPParams"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_app_modules_wiki.createEntryRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "assistant_internal_app_repo.SearchSysServersByIDCAndSvrIPParams": {
            "type": "object",
            "properties": {
                "idc": {
                    "type": "string"
        ...
        "assistant_internal_app_repo.SearchSysServersByIDCParams": {
            "type": "object",
            "properties": {
                "idc": {
                    "type": "string"
        ...
        "assistant_internal_app_repo.SearchSysServersBySvrIPParams": {
            "type": "object",
            "properties": {
                "limit": {
                    "type": "integer"
        ...
        "internal_app_modules_sys_distributed_lock.acquireReq": {
            "type": "object",
            "properties": {
                "lock_holder": {
                    "type": "string"
        ...
        "internal_app_modules_sys_distributed_lock.releaseReq": {
            "type": "object",
            "properties": {
                "lock_holder": {
                    "type": "string"
        ...
        "internal_app_modules_sys_distributed_lock.renewReq": {
            "type": "object",
            "properties": {
                "lock_holder": {
                    "type": "string"
        ...
        "internal_app_modules_wiki.createEntryRequest": {
            "type": "object",
            "required": [
                "content",
                "title"
