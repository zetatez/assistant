...
要求：
1. 用 Markdown 格式输出, 答案优先, 包含简要解释说明, 要求结构清晰、简洁、准确
2. 题目可能是单选题、多选题、判断题、填空题、简答题、编程题等
3. 如涉及代码问题, 根据题目要求选择合适的编程语言, 比如 sql、shell、go、python、mongodb 查询语法等
4. 默认用中文回答, 除非问题本身要求使用其他语言
5. 只输出回答正文, 不要输出任何多余内容
`
